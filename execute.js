...
function end(){
  ...
  $.ajax({
    ...
    success: function (data) {
        ...
        document.querySelector('.U26fgb.JRY2Pb.mUbCce.kpROve.GaONte.Qwoy0d.ZPasfd.vzpHY').setAttribute('data-tooltip', "課程已結束，請按此結束通話");
        document.querySelector('.U26fgb.JRY2Pb.mUbCce.kpROve.GaONte.Qwoy0d.ZPasfd.vzpHY').setAttribute('aria-label', "課程已結束，請按此結束通話");    
        document.querySelector('.U26fgb.JRY2Pb.mUbCce.kpROve.GaONte.Qwoy0d.ZPasfd.vzpHY').style.background='#fff';
...
// }
  ...
  //此處放測試ㄉ程式碼
  // if(document.querySelectorAll('.barchart_window').length!=0){
  //   document.querySelectorAll('.barchart_window').forEach(function(a){
  //     a.parentNode.removeChild(a);
  //   })
  // }
  // var meet_window=document.getElementsByClassName("zWfAib")[0];
  // var barchart_window = document.createElement("div");
  // barchart_window.className="barchart_window xsj2Ff Zf0RDc PoIECb AwnI1b";
  // barchart_window.style.cssText ="background-color: red; right:0;";
  // barchart_window.style.width=document.getElementsByClassName("PoIECb")[0].style.width;
  // barchart_window.style.height=document.getElementsByClassName("PoIECb")[0].style.height;
  // barchart_window.style.top=document.getElementsByClassName("PoIECb")[0].style.top;
  // barchart_window.setAttribute("jscontroller", "J3CtX");
  // barchart_window.setAttribute("jsname", "E2KThb");
  // barchart_window.setAttribute("jsmodel", "AwTKuc STgNKd");
  // barchart_window.setAttribute("jsaction", document.getElementsByClassName("PoIECb")[0].getAttribute("jsaction"));
  // barchart_window.setAttribute("data-allocation-index", "100");
  // // barchart_window.innerHTML='<div id="barchart_values" style="display:flex;align-items: center;justify-content: center;width: auto; height: 300px;"></div>';
  // barchart_window.innerHTML='<div jsaction="GvneHb:ygrqGc" class="koV58 Zi94Db S7urwe" jsname="Nl0j0e" jscontroller="k8QGV" data-resolution-cap="2" data-layout="roi-crop" style="background-color:red"><div class="p2hjYe TPpRNe" data-ssrc="2913764808" style="width: 424px; height: 239px; left: 0px; top: -1px;">測試</div></div>';
  // meet_window.appendChild(barchart_window);
  //此處放測試ㄉ程式碼